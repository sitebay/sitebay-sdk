...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class TeamMember :  IEquatable<TeamMember>, IValidatableObject
    {
        ...
        public TeamMember(string id = default(string), User user = default(User))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for TeamMember and cannot be null");
            }
            else
            {
                this.Id = id;
