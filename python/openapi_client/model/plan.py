...
class Plan(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created, ends, id, plan_type_name, user_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created, ends, id, plan_type_name, user_id, *args, **kwargs):  # noqa: E501
        """Plan - a model defined in OpenAPI
