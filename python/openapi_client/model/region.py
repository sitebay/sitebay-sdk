...
class Region(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, city, cname, country, country_code, created, id, ip, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, city, cname, country, country_code, created, id, ip, name, *args, **kwargs):  # noqa: E501
        """Region - a model defined in OpenAPI
