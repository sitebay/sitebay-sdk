...
class Team(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, created, id, name, plan_id, timezone, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, created, id, name, plan_id, timezone, *args, **kwargs):  # noqa: E501
        """Team - a model defined in OpenAPI
