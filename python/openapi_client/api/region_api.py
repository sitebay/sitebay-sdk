...
class RegionApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_region_endpoint = _Endpoint(
            settings={
                'response_type': (Region,),
                'auth': [],
                'endpoint_path': '/api/v1/region/{region_id}',
    ...
    def get_region(
        ...
        **kwargs
        ...
        Get details of a region by its ID  # noqa: E501
        ...
        kwargs['region_id'] = \
            region_id
        return self.get_region_endpoint.call_with_http_info(**kwargs)
    ...
    def get_regions(
        ...
        **kwargs
        ...
        Get details of all regions  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
